...
//////////////////////////// ENCONDER ///////////////////
const byte    C1 = 2; // Entrada de la señal A del encoder (Cable verde).
const byte    C2 = 3; // Entrada de la señal B del encoder (Cable amarillo).
...
//  motor.lambdaTunning(5.3503,0.0001,0.2999); // (K,tau,delay)
...
//  Serial.println(motor.getTd());
 ...
 // motor.setGains(0.2 , 0.054, 0.07); // (Kc,Ti,Td)
 motor.setGains(0.19 ,  0.10, 0.00); // (Kc,Ti,Td)
